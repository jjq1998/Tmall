            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${askList}" var="ask">
                    <tr>
                        ...
                        <td>${ask.admin}</td>
                        <td>
                            <a href="/ask/selectAskById?id=${ask.id}">查看</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
            <ul class="pagination" style="margin: 10px auto auto;">
                <li class="page-item"><a class="page-link" href="/ask/askList?page=${page-1}">上一页</a></li>
                <li class="page-item"><a class="page-link" href="#">${page}/${totalPage}</a></li>
                <li class="page-item"><a class="page-link" href="/ask/askList?page=${page+1}">下一页</a></li>
            </ul>
        </div>
    </div>
</div>
