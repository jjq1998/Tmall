            ...
            <div id="shopForm">
                <form action="/shop/submitAsk" enctype="multipart/form-data" method="post">
                    ...
                    <div class="input-group mb-3 custom-control-inline" id="nameInput">
                        <input type="text" class="form-control" placeholder="店铺名称" id="name" name="name" value="${ask.shop.name}" readonly>
                    </div>
                    ...
                    <div class="custom-file mb-3 custom-control-inline" id="imageInput">
                        ...
                        <label id="labelForImage" class="custom-file-label" for="customFile">${ask.shop.image}</label>
                    </div>

                    <div id="editor">
                        <label for="kindedito">申请材料</label><textarea name="content" id="kindedito">${ask.content}</textarea>
                    </div>
                </form>
            </div>
        </div>
