    ...
    <div class="row" id="middle">
            ...
            var details = ${goods.details}
                $(function () {
                    $.each(details, function (i) {
                        $("#details_div_ul").append(
                            "<li class='list-inline-item'>" + i + ":" + details[i] + "</li>"
                        );
                    })
                })
        </script>
        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>商品ID：${goods.id}</h5>
                    <h5>商品状态：${goods.state}</h5>
                    <h5>商品价格：${goods.price}</h5>
                </div>
                <div class="col-sm-6">
                    <h5>商品名称：${goods.name}</h5>
                    <h5>销售量：${goods.salesCount}</h5>
                </div>
            </div>
            <div id="details_div">
                <p>品牌名称：${brand.name}</p>
                <p>商品参数：</p>
                <ul id="details_div_ul" class="list-inline">
