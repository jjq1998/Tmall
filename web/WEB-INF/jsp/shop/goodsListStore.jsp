                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${goodsList}" var="goods">
                        <tr>
                            ...
                            <td>${goods.state}</td>
                            <td>
                                <button type="button" class="btn btn-success"><a href="/goods/goodsById?id=${goods.id}">查看详情</a></button>
                                <button type="button" class="btn btn-primary"><a href="/goods/goodsParamInsert?id=${goods.id}">添加参数</a></button>
                                <button type="button" class="btn btn-success"><a href="/goods/goodsUpdate?id=${goods.id}">更改信息</a></button>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
